      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <ScrollArea className="h-72 bg-muted rounded-lg p-2 border-2 border-orange-400">
            <div className="space-y-2">
              {milkIceCreams.map((iceCream, index) => (
                <div
                  key={index}
                  className="bg-white text-orange-400 py-1 px-2 rounded-md"
                >
          ...
          <div className="flex justify-around mt-6">
            <button className="bg-orange-400 text-primary-foreground py-2 px-4 rounded-md hover:bg-orange-500/90">
              Pridať
            </button>
            <button className="bg-orange-400 text-primary-foreground py-2 px-4 rounded-md hover:bg-orange-500/90">
              Odstrániť
